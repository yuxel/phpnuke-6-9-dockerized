 ...
 *
 *   $Id: usercp_register.php,v 1.20.2.51 2003/06/11 10:05:15 psotfx Exp $
 *
 *
 ***************************************************************************/
/***************************************************************************
        ...
        if ( !$error )
        {
                ...
                if ( $mode == 'editprofile' )
                {
                        ...
                        if ( !($result = $db->sql_query($sql)) )
                        {
                            ...
                            // The database "Stuff" has been done, but the nuke theme is "cookie-based" until they relog-in
                            // Lets re-set the cookie now huh ;)
