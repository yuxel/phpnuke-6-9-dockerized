...
define("_WEBMAILSERVICE","Servizio WebMail");
...
define("_EXIT","Esci");
define("_MAILWELCOME1","Settando nuovi account puoi scaricare le mail da qualsiasi server (pop3) desideri senza doverti ogni volta loggare manualmente in ciascuno di essi. Controllare la tua posta sar&agrave; molto pi&ugrave; semplice per te, d'ora in poi.");
define("_MAILWELCOME2","Settando il tuo account puoi scaricare le mail dal tuo server POP3 senza doverti ogni volta loggare manualmente. Controllare la tua posta sar&agrave; molto pi&ugrave; semplice per te, d'ora in poi.");
...
define("_PRIORITY","Priorit&agrave;");
define("_HIGH","Alta");
...
define("_SAVE","Salva");
define("_ADDNEW","Aggiungi nuovo");
define("_MAILBOXESSETTINGS","Configurazione caselle mail");
...
define("_RELATEDEVENTSMSG","Elenca gli eventi relativi a questa persona, come Compleanno, Anniversario ecc. o qualsiasi altra data speciale che vorresti ti sia ricordata. Aggiungi tutti gli eventi che desideri.<br> Per aggiungere un evento usa: <i>Event name: date</i> (es: Compleanno: 03/21) (nota: il format della data &egrave; mm/dd)");
define("_REMINDME","Ricordami");
define("_DAYSBEFORE","giorno(i) prima dell'evento");
define("_NOTES","Note");
define("_SUBMIT","Invia");
define("_VIEW","Vedi");
define("_LISTALL","Elenca tutto");
define("_IN","in");
define("_ALL","Tutto");
define("_RESULTSFOUND","Risultato(i) trovato(i)");
define("_VIEWPROFILE","Vedi profilo");
define("_EDITCONTACT","Edita contatto");
define("_EDITCONTACTS","Edita contatti");
...
define("_MESSAGESENT","Il tuo messaggio &egrave; stato inviato.");
