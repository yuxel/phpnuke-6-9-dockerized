...
define("_LAST10COMMENTS","最近的十項意見，關於");
...
define("_USERCHECKDATA","請檢查下列資料. 如果完全正確可以按 \"完成\" 鈕, 否則 \"返回\" 看看還有什麼要改的.");
define("_USERFINALSTEP","新會員註冊: 最後一個步驟");
define("_ACCOUNTCREATED","新會員帳號建立成功!");
define("_THANKSUSER","謝謝您的註冊");
define("_YOUCANLOGIN","幾分鐘後,你回收到一封我們寄的 email 上面有你的密碼. 然後你可以按 <a href=\"modules.php?name=Your_Account\">這裏</a>登錄. 記得去改你的密碼和設定你個人的偏好設定.希望您對我們的服務滿意.");
...
define("_WEBMAIL", "網頁郵件");
define("_MESSAGES","訊息");
define("_RETURNACCOUNT", "返回你的帳號頁面");
define("_ACCESSTO", "存取於");
define("_CREATEJOURNAL", "建立你的電子報");
define("_READHEADLINES", "閱讀一般標題");
